...
$lang = array_merge($lang,array(
	...
	"ACCOUNT_PROGRAM_UPDATED"		=> "%m1%'s program changed to %m2%",
	"ACCOUNT_BANK_INIT"			=> "%m1%'s bank account created with 10.000 SKEMs",
	"ACCOUNT_CAMPUS_UPDATED"		=> "%m1%'s campus changed to %m2%",
	...
	"ACCOUNT_NEW_USER_WELCOME"		=> "Welcome to SKEM Bank",
	));
