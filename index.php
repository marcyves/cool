...
if(!empty($_POST))
{
    ...
    // Check if user is defined locally in our Database
    ...
    if(usernameExists($username))
    {
        ...
        // User is not defined locally, check LDAP
...
echo "
<p>Welcome to our system for matching your research interests with an advisor.<p>";

title("home","Please login");
